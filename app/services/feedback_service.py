...
def save_feedback(data: FeedbackRequest, email: str):
    print("DEBUG | save_feedback çalıştı")
    ...
    try:
        ...
        print("[GUIDELINE WARNING] update_live_guideline hata verdi:", str(e))
    ...
    try:
        ...
        print("[GUIDELINE WARNING] fetch_user_feedbacks hata verdi:", str(e))
